...
<div class="confirmPayPageDiv">
    <div class="confirmPayImageDiv">
        <img src="${APP_PATH}/img/site/comformPayFlow.png">
        <div class="confirmPayTime1">
            <fmt:formatDate value="${orderItem.createDate}" pattern="yyyy-MM-dd HH-mm-ss" />
        </div>
        <div class="confirmPayTime2">
            <fmt:formatDate value="${orderItem.payDate}" pattern="yyyy-MM-dd HH-mm-ss" />
        </div>
        <div class="confirmPayTime3">
            <fmt:formatDate value="${orderItem.confirmDate}" pattern="yyyy-MM-dd HH-mm-ss" />
        </div>
    ...
    <div class="confirmPayOrderItemDiv">
        ...
        <table class="confirmPayOrderItemTable">
            ...
            <c:forEach items="${orderItem.orderItems }" var="orderItems" >
                <tr>
                    <td><img width="50px" src="../../img/productSingle_middle/1917.jpg"></td>
                    <td class="confirmPayOrderItemProductLink">
                        <a href="/foreproduct?pid=${orderItems.product.id}">${orderItems.product.name }</a>
                    </td>
                    <td>￥${orderItems.product.promotePrice }</td>
                    <td>${orderItems.number}</td>
                    <td><span class="conformPayProductPrice">￥${orderItems.singleTotal }</span></td>
        ...
        <div class="confirmPayOrderItemText pull-right">
            实付款： <span class="confirmPayOrderItemSumPrice">￥${orderItem.totalPrice}</span>
        </div>
    ...
    <div class="confirmPayOrderDetailDiv">
        ...
        <table class="confirmPayOrderDetailTable">
            <tr>
                <td>订单编号：</td>
                <td>${orderItem.orderCode} <img width="23px" src="../../img/site/confirmOrderTmall.png"></td>
            </tr>
            <tr>
                <td>卖家昵称：</td>
            ...
            <tr>
                <td>收货信息：</td>
                <td>${orderItem.address }，${orderItem.receiver}， ${orderItem.mobile}，${orderItem.post}</td>
            </tr>
            <tr>
                <td>成交时间：</td>
                <td><fmt:formatDate value="${orderItem.payDate}" pattern="yyyy-MM-dd HH-mm-ss" /></td>
            </tr>
        </table>
    ...
    <div class="confirmPayButtonDiv">
        ...
        <a href="/order/confirmGoods/${orderItem.id}">
