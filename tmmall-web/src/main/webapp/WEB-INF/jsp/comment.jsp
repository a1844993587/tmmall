...
<div class="reviewDiv">
    <div class="reviewProductInfoDiv">
        <div class="reviewProductInfoImg"><img width="400px" height="400px" src="${APP_PATH}/img/productSingle/1917.jpg">
        </div>
        <div class="reviewProductInfoRightDiv">
            <div class="reviewProductInfoRightText">
                ${orders.orderItems[0].product.name}
            </div>
            <table class="reviewProductInfoTable">
                <tr>
                    <td width="75px">价格:</td>
                    <td><span class="reviewProductInfoTablePrice">￥ ${orders.orderItems[0].product.orignalPrice}</span> 元</td>
                </tr>
                <tr>
                    <td>配送</td>
                    <td>快递: 0.00</td>
                ...
                <tr>
                    <td>月销量:</td>
                    <td><span class="reviewProductInfoTableSellNumber">15</span> 件</td>
                </tr>
            </table>

            <div class="reviewProductInfoRightBelowDiv">
                <span class="reviewProductInfoRightBelowImg"><img1 src="${APP_PATH}/img/site/reviewLight.png"></span>
                <span class="reviewProductInfoRightBelowText">现在查看的是 您所购买商品的信息
于<fmt:formatDate value="${orders.createDate}" pattern="yyyy年MM月dd" />下单购买了此商品 </span>
            </div>
        </div>
        <div style="clear:both"></div>
    </div>
    <div class="reviewStasticsDiv">
        <div class="reviewStasticsLeft">
            ...
            <div class="reviewStasticsLeftContent">累计评价 <span class="reviewStasticsNumber"> 15</span></div>
    ...
    <div class="makeReviewDiv">
        <form method="post" action="/review/insert">
            ...
            <div class="makeReviewButtonDiv">
                ...
                <input type="hidden" name="pid" value="${orders.orderItems[0].product.id}">
...
<script>
    /**
     * 传过来的orders对象  里面包含了订单id orders.id  和商品id  orders.orderItems[0].id
     * 穿过去后端的时候务必请把订单id传过来
     */
    console.log(${orders.orderItems[0].id})
</script>
