...
<div class="payedDiv">
    <div class="payedTextDiv">
        <img src="${APP_PATH}/img/site/paySuccess.png">
        <span>您已成功付款</span>

    </div>
    <div class="payedAddressInfo">
        <ul>
            <li>收货地址：${orderItem.address}</li>
        ...
        <div class="paedCheckLinkDiv">
            您可以
            <a class="payedCheckLink" href="/order/findAllUserOrderItem">查看已买到的宝贝</a>
            <a class="payedCheckLink" href="/order/findAllUserOrderItem">查看交易详情 </a>
        </div>
    ...
    <div class="warningDiv">
        <img src="${APP_PATH}/img/site/warning.png">
