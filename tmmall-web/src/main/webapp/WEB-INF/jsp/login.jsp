...
<div id="loginDiv" style="position: relative">
    ...
    <div class="simpleLogo">
        <img src="${APP_PATH}/img/site/simpleLogo.png">
    </div>

    <img id="loginBackgroundImg" class="loginBackgroundImg" src="${APP_PATH}/img/site/loginBackground.png">

    <form class="loginForm" action="/denglu/loginWeb" method="post">
        <div id="loginSmallDiv" class="loginSmallDiv">
            ...
            <div>
                ...
                <a href="/regist" class="pull-right">免费注册</a>
            </div>
            <div style="margin-top:20px">
                <input type="submit" class="btn btn-block redButton" value="登录">
            </div>
        </div>
    </form>
