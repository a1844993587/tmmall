...
<head>
    ...
    <script src="${APP_PATH}/study/js/ajaxd.js"></script>
    <style>
        .show {
...
<title>模仿天猫官网 名媛2016新款女装夏两件套裤韩版雪纺七分裤阔腿裤休闲时尚套装女</title>
...
<div class="productPageDiv">
    ...
    <script>
        ...
        $(function () {
            ...
            $(document).on('mouseenter', 'img.smallImage', function () {
    ...
    <div class="imgAndInfo">
        <script>
            function loadImgAndInfo() {
                $.ajax({
                    type: "POST",
                    url: "${APP_PATH}/getProduct",
                    async : false,
                    data : "pid=${pid}",
                    success : function (result) {
                        window.product = result.data;
                        var html = "";
                        html += '<img src="${APP_PATH}/img/productSingle/'+product.firstProductImage.id+'.jpg" class="bigImg">';
                        html += '	<div class="smallImageDiv">';
                        $.each(product.productSingleImages, function (i, productSingleImage) {
                            html += '<img src="${APP_PATH}/img/productSingle_small/'+productSingleImage.id+'.jpg" bigImageURL="${APP_PATH}/img/productSingle/'+productSingleImage.id+'.jpg" class="smallImage">';
                        });
                        html += '	</div>';
                        html += '<div class="img4load hidden"></div>';
                        $(".imgInimgAndInfo").html(html);
                        $(".productTitle").append(product.name);
                        $(".productSubTitle").append(product.subTitle);
                        $(".originalPrice").append(product.orignalPrice);
                        $(".promotionPrice").append(product.promotePrice);
                        $(".stock").append("库存"+product.stock+"件");
                        $(".categoryPictureInProductPage").attr("src",'${APP_PATH}/img/category/'+product.category.id+'.jpg');
                    }
                })
            }
        </script>
        ...
        <div class="infoInimgAndInfo">
            ...
            <div class="productPrice">
                ...
                <div class="productPriceDiv">
                    <div class="gouwujuanDiv"><img height="16px" src="${APP_PATH}/img/site/gouwujuan.png">
                        <span> 全天猫实物商品通用</span>
            ...
            <div class="productNumber">
				...
				<span class="arrow">
					...
					<span class="updown">
							<img src="${APP_PATH}/img/site/increase.png">
					</span>
					</a>
					...
					<span class="updown">
							<img src="${APP_PATH}/img/site/decrease.png">
					</span>
					</a>
            ...
            <div class="buyDiv">
                <a class="buyLink" onclick="toBillingPage(${pid})">
    ...
    <script>
        function toBillingPage(pid){
            var number = $(".productNumberSetting").val();
            if (number <= 0) number = number * -1;
            window.location.href = "/car/settlementShopCar?pid="+pid+"&number="+number;
        }
         ...
         * 评价
         */
        $(document).on('click','.productDetailTopReviewLink',function () {
            var productReview = $(".productReviewContentPart").children();
            if (productReview != null){
                $(".productReviewContentPart").empty();
            }
            $.ajax({
                type: "GET",
                url: "/review/select?pid=${pid}",
                success: function (result) {
                    var html="";
                    var reviewList = result.data;
                    $.each(reviewList,function(i,review){
                        html+='<div class="productReviewItem">';
                        html+='	<div class="productReviewItemDesc">';
                        html+='		<div class="productReviewItemContent">';
                        html+='			'+review.content+'';
                        html+='		</div>';
                        html+='		<div class="productReviewItemDate">'+review.createDate+'</div>';
                        html+='	</div>';
                        html+='	<div class="productReviewItemUserInfo">';
                        html+='		'+review.username+'';
                        html+='	</div>';
                        html+='	<div style="clear:both"></div>';
                        html+='</div>';
                    });
                    $(".productReviewContentPart").html(html);
                }
            })
        })
        ...
        $(function () {
            $.ajax({
                type: "GET",
                url: "/review/count?pid=${pid}",
                success: function (result) {
                    var reviewCount = result.data;
                    $(".productDetailTopReviewLinkNumber").html(reviewCount);
                    $(".productReviewTopReviewLinkNumber").html(reviewCount);
                }
            })
    ...
    <div class="productReviewDiv">
        <div class="productReviewTopPart">
            ...
            <a href="#nowhere" class="selected">累计评价 <span class="productReviewTopReviewLinkNumber">19</span> </a>
        </div>
    ...
    <div class="productDetailDiv">
        <div class="productDetailTopPart">
            ...
            <a href="#nowhere" class="productDetailTopReviewLink">累计评价 <span
                    class="productDetailTopReviewLinkNumber">19</span> </a>
        </div>
        ...
        <div class="productDetailImagesPart">
            ...
            <img src="${APP_PATH}/img/productDetail/8626.jpg">

            <img src="${APP_PATH}/img/productDetail/8625.jpg">

            <img src="${APP_PATH}/img/productDetail/8624.jpg">

            <img src="${APP_PATH}/img/productDetail/8623.jpg">

            <img src="${APP_PATH}/img/productDetail/8622.jpg">

            <img src="${APP_PATH}/img/productDetail/8621.jpg">
